...
|ssh&nbsp;admin@localhost&nbsp;-p&nbsp;8101 | The Horizon Karaf CLI via SSH<BR>If yo dont have an SSH client, you can access this using `docker compose exec horizon ssh admin@localhost -p 8101` |
